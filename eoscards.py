...
* store users in separate file so they can return to play again.
'''
...
def ask_q(answer, anspad, user):
    ...
    print("1) {}\n2) {}\n3) {}\n4) {}\n\n".format(anspad[0], anspad[1], anspad[2], anspad[3]))
    print("Answer: ")
...
class USER():
    ...
    def update_time(self, start_time, end_time, answer):
        ...
        self.answer.times_answeered += 1
        self.answer.cum_time += ans_time
        self.answer.avg_time = self.answer.cum_time / self.answer.times_answeered
